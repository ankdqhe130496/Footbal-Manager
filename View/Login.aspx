<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="FootbalManager.View.Login" %>
    ...
    <form id="form1" runat="server">
        <div class="wrapper1">
            ...
            <div class="logincontainer">
                ...
                <h3>
                    <img src="images/login.png" width="50px" height="50px" /> Admin Login
                </h3>

                <hr />

                <asp:TextBox runat="server" ID="txtUserId" placeholder="Enter Account" CssClass="form-control" OnTextChanged="txtUserId_TextChanged"/>
                <br />
